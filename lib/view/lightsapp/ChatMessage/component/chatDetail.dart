...
import 'package:flutterapp/view/lightsapp/ChatMessage/component/ibMessage.dart';
...
class ChatDetail extends StatefulWidget {
  ...
  const ChatDetail({Key? key, required this.name, required this.image})
      : super(key: key);
...
class _ChatDetailState extends State<ChatDetail> {
  ...
  void _sendMessage() async {
    ...
    IbMessage message = IbMessage(text: _controller.text, sender: "user");
    setState(() {
      _message.insert(0, message);
    });
